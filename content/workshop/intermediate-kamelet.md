...
description: "Create a Kamelet"
draft: false
kaoto: 2.0.0
vscode_kaoto: 0.11.0
goals: learn how to create a Kamelet using Kaoto. We are going to create something similar to the [Chuck Norris source](https://camel.apache.org/camel-kamelets/4.0.x/chuck-norris-source.html), but generating cat facts
---
...
<video width=100% controls >
    <source src="/images/workshop/intermediate-kamelet/1-create-kamelet.webm" type="video/webm">
...
<video width=100% controls >
    <source src="/images/workshop/intermediate-kamelet/2-configure-metadata.webm" type="video/webm">
    Your browser does not support the video tag.
</video>
...
<video width=100% controls >
    <source src="/images/workshop/intermediate-kamelet/3-configure-unmarshal.webm" type="video/webm">
    Your browser does not support the video tag.
</video>
...
<video width=100% controls >
    <source src="/images/workshop/intermediate-kamelet/4-add-dependency.webm" type="video/webm">
    Your browser does not support the video tag.
</video>
